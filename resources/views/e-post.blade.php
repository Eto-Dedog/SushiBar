...
@section('content')
    <section class="section__promo-sub-one section">
        <div class="container">
            <div class="promo__sub-block sl-1-block">
                <h1 class="promo__sub-title">Редактирование Поста</h1>
    ...
    <!-- /.sc-admin-bar -->
    <form action="{{ route('posts.update', ['id' => $post->post_id]) }}" method="post" class="form-c-e" enctype="multipart/form-data">
        @method('PATCH')
        @include('parts.form-post')
    </form>
@endsection
