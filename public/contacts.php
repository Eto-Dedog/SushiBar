        ...
        <div class="container">
            <div class="header__block block">
                ...
                <nav class="header__nav nav">
                    ...
                    <!-- /.header__nav__link nav__link link -->
                    <a href="contacts.php" class="header__nav__link nav__link link active">Контакты</a>
                    <!-- /.header__nav__link nav__link link -->
                </nav>
                <!-- /.header__nav nav -->
            </div>
        ...
        <div class="modal__burger__body">
            <div class="header__block block">
                <nav class="burger__nav nav">
                    ...
                    <!-- /.header__nav__link nav__link link -->
                    <a href="contacts.php" class="burger__nav__link nav__link link active">Контакты</a>
                    <!-- /.header__nav__link nav__link link -->
