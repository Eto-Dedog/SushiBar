        ...
        <div class="container">
            <div class="header__block block">
                ...
                <nav class="header__nav nav">
                    ...
                    <a href="menu.php" class="header__nav__link nav__link link active">Меню</a>
                    <!-- /.header__nav__link nav__link link -->
        ...
        <div class="modal__burger__body">
            <div class="header__block block">
                <nav class="burger__nav nav">
                    ...
                    <!-- /.header__nav__link nav__link link -->
                    <a href="menu.php" class="burger__nav__link nav__link link active">Меню</a>
                    <!-- /.header__nav__link nav__link link -->
