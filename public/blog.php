        ...
        <div class="container">
            <div class="header__block block">
                ...
                <nav class="header__nav nav">
                    ...
                    <!-- /.header__nav__link nav__link link -->
                    <a href="blog.php" class="header__nav__link nav__link link active">Блог</a>
                    <!-- /.header__nav__link nav__link link -->
        ...
        <div class="modal__burger__body">
            <div class="header__block block">
                <nav class="burger__nav nav">
                    ...
                    <!-- /.header__nav__link nav__link link -->
                    <a href="blog.php" class="burger__nav__link nav__link link active">Блог</a>
                    <!-- /.header__nav__link nav__link link -->
