...
<head>
    ...
    <script src="js/userfulTab.js" defer></script>
    <title>SushiBar - Мой аккаунт</title>
</head>
<body>
    ...
    <div class="modal__user d-none">
        ...
        <div class="modal__user__body">
            ...
            <br>Мой Аккаунт</a></h2>
            <div class="modal__user__no-auth d-none">
            ...
            <div class="modal__user__auth">
                <a href="account.php" class="link modal__user__auth-link">Панель управления</a>
                <a href="products.php" class="link modal__user__auth-link">Продукты</a>
                <a href="#" class="link modal__user__auth-link">Отзывы</a>
                <a href="account.php" class="link modal__user__auth-link ">Подробней об акаунте</a>
                <a href="index.php" class="link modal__user__auth-link">Выход</a>
            </div>
            <!-- /.modal__user__auth -->
