        ...
        <div class="container">
            <div class="header__block block">
                ...
                <nav class="header__nav nav">
                    ...
                    <!-- /.header__nav__link nav__link link -->
                    <a href="about.php" class="header__nav__link nav__link link active">О&nbsp;нас</a>
                    <!-- /.header__nav__link nav__link link -->
      ...
      <div class="container">
        <div class="about__block">
          <div class="about__box">
            ...
            <!-- /.about__box__events -->
            <a href="contacts.php" class="about__box__contacts btn link">КОНТАКТЫ</a>
        ...
        <div class="modal__burger__body">
            <div class="header__block block">
                <nav class="burger__nav nav">
                    ...
                    <!-- /.header__nav__link nav__link link -->
                    <a href="about.php" class="burger__nav__link nav__link link active">О&nbsp;нас</a>
                    <!-- /.header__nav__link nav__link link -->
