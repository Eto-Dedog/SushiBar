...
<head>
    ...
    <script src="js/special-sets.js" defer></script>
        ...
        <div class="container">
            <div class="header__block block">
                ...
                <nav class="header__nav nav">
                    <a href="index.php" class="header__nav__link nav__link link active">Главная</a>
                ...
                <div class="sets__slides">
                    <div class="sets__slide">
                        ...
                        <div class="sets__slide__box">
                            ...
                            <!-- /.sets__price -->
                            <a href="contacts.php" class="sets__btn btn link">
        ...
        <div class="modal__burger__body">
            <div class="header__block block">
                <nav class="burger__nav nav">
                    <a href="/" class="header__auth__link link"><img src="img/home/logo.png" alt="logo" class="header__logo logo"></a>
                    <a href="index.php" class="burger__nav__link nav__link link active">Главная</a>
                    <!-- /.header__nav__link nav__link link -->
