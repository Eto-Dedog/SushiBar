...
<body>
        ...
        <div class="container">
            <div class="header__block block">
                ...
                <nav class="header__nav nav">
                    <a href="index.php" class="header__nav__link nav__link link">Главная</a>
                    <!-- /.header__nav__link nav__link link -->
                    <a href="menu.php" class="header__nav__link nav__link link">Меню</a>
                    <!-- /.header__nav__link nav__link link -->
                    <a href="information.php" class="header__nav__link nav__link link">Информация</a>
                    <!-- /.header__nav__link nav__link link -->
                    <a href="blog.php" class="header__nav__link nav__link link">Блог</a>
                    <!-- /.header__nav__link nav__link link -->
                    <a href="about.php" class="header__nav__link nav__link link">О&nbsp;нас</a>
                    <!-- /.header__nav__link nav__link link -->
                    <a href="contacts.php" class="header__nav__link nav__link link">Контакты</a>
                    <!-- /.header__nav__link nav__link link -->
                </nav>
                <!-- /.header__nav nav -->
            </div>
    ...
    <section class="section__promo-sub-one section">
        <div class="container">
            <div class="promo__sub-block sl-1-block">
              ...
              <span>
              <a href="index.php" class="promo__info__text text link promo__link">Главаная > </a>
              <a href="blog.php" class="promo__info__text text link promo__link">Блог > </a>
              </span>
            </div>
            <!-- /.promo__block -->
        </div>
        ...
        <div class="news__cards">
            <div class="news__card">
              ...
              <div class="news__card__box">
                ...
                <span class="news__card__date text"><img src="img/home/calendar.svg" alt="calendar" class="news__card__icon"> Март 13, 2022 / Пост создал:<a href="#" class="link">Admin</a> / <img src="img/home/eye.svg" alt="eye" class="news__card__icon"> 0 / <img src="img/home/comment.svg" alt="calendar" class="news__card__icon"> 0 </span>
                <p class="news__card__text text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Distinctio quam culpa, quo ad debitis ullam quae fuga, deserunt necessitatibus illo suscipit vel minus dicta corrupti eligendi enim qui saepe veritatis, cumque magni. Omnis velit, ex dolorem aspernatur nihil nostrum quia provident? Perspiciatis eveniet repellendus maiores dolores fuga iure repellat, deserunt excepturi incidunt neque vel ea! Assumenda consequuntur magnam quas officia consequatur totam, laborum, aliquid minima repellat deleniti molestias. Repudiandae blanditiis hic ab fugit non dolorum ipsum quo est rem ipsam. Harum, fugiat voluptates pariatur eveniet ut magnam numquam suscipit quidem natus necessitatibus, nemo vero similique, sequi mollitia architecto iure atque enim tempore? Molestias nulla assumenda quae dolor, reprehenderit quas, dolore optio, inventore adipisci rem iure illum nihil fugit maiores. Ea, illo quasi suscipit odit fugiat tempore nobis fugit omnis quisquam. Inventore obcaecati voluptas praesentium provident sit saepe quibusdam ut debitis necessitatibus, voluptate quae quo veritatis ipsum cum, quos vitae quod mollitia et reiciendis consectetur id a in delectus. Fugiat minima voluptates, eaque doloremque neque debitis repellendus alias atque aspernatur ea totam ipsum, reiciendis magni necessitatibus ratione facere culpa labore quia voluptatibus obcaecati. Nemo natus tempore repudiandae at quasi. Accusantium ipsam iure molestias recusandae perferendis, dolores odio provident veniam saepe exercitationem! Voluptates corporis neque ad a, modi omnis repellendus sequi delectus eveniet deserunt voluptatibus similique consequuntur? Reprehenderit delectus quisquam nobis labore atque ipsum a impedit officia maxime illo, cum quos, cupiditate odio dolorem iusto maiores, expedita ratione itaque aliquid. Ex nobis natus est aliquam atque ratione architecto repellat quo corporis eveniet fugit animi illum rem adipisci doloremque laudantium temporibus, in ullam et consequatur quidem impedit delectus? Pariatur ipsum est, omnis inventore placeat provident! Molestias reprehenderit maiores rerum id doloribus laudantium voluptates soluta, asperiores ratione perspiciatis, ullam adipisci qui tempore esse, obcaecati nisi recusandae alias consequuntur optio corrupti. Aut optio atque odio distinctio qui doloremque quas ducimus laborum cupiditate fugiat illum corporis assumenda itaque sit perspiciatis debitis sed, deleniti suscipit tenetur totam.</p>
                <p class="news__card__text text">Lorem ipsum, dolor sit amet consectetur adipisicing elit.
ellendus alias atque aspernatur ea totam ipsum, reiciendis magni necessitatibus ratione facere culpa labore quia voluptatibus obcaecati. Nemo natus tempore repudiandae at quasi. Accusantium ipsam iure molestias recusandae perferendis, dolores odio provident veniam saepe exercitationem! Voluptates corporis neque ad a, modi omnis repellendus sequi delectus eveniet deserunt voluptatibus similique consequuntur? Reprehenderit delectus quisquam nobis labore atque ipsum a impedit officia maxime illo, cum quos, cupiditate odio dolorem iusto maiores, expedita ratione itaque aliquid. Ex nobis natus est aliquam atque ratione architecto repellat quo corporis eveniet fugit animi illum rem adipisci doloremque laudantium temporibus, in ullam et consequatur quidem impedit delectus? Pariatur ipsum est, omnis inventore placeat provident! Molestias reprehenderit maiores rerum id doloribus laudantium voluptates soluta, asperiores ratione perspiciatis, ullam adipisci qui tempore esse, obcaecati nisi recusandae alias consequuntur optio corrupti. Aut optio atque odio distinctio qui doloremque quas ducimus laborum cupiditate fugiat illum corporis assumenda itaque sit perspiciatis debitis sed, deleniti suscipit tenetur totam.</p>
              </div>
              <!-- /.news__card__box -->
                ...
                <div class="news__cards">
                    <div class="news__card">
                      ...
                      <div class="news__card__box">
                        ...
                        <a href="post.php" class="news__card__btn text link">Продолжить чтение</a>
                      </div>
                      <!-- /.news__card__box -->
                    </div>
                    <!-- /.news__card -->
    ...
    <section class="section__comments__post section">
        <div class="container">
            <div class="comments__post__block">
                <h3>1 комментарий в "Сообщение с цитатой"</h3>
        ...
        <div class="container">
            <div class="footer__block">
                ...
                <div class="footer__box">
                    ...
                    <a href="about.php" class="text link footer__link">История ресторана</a>
    ...
    <div class="modal__newsletters d-none">
        <div class="modal__newsletters__overlay"></div>
            ...
            <div class="modal__user__no-auth">
                ...
                <form action="#" method="get" class="form-user form__modal__user-login">
                    <div class="form__modal__user__box">
                        <label class="form__modal__user__label label" for="log-email">Ведите ваш e-mail *</label>
                        <input class="form__modal__user__input input" type="email" id="log-email" required>
                    </div>
                    <!-- /.form__modal__user__box -->
                    <div class="form__modal__user__box">
                        <label class="form__modal__user__label label" for="log-pass">Ведите ваш пароль *</label>
                ...
                <form action="#" method="post" class="form-user form__modal__user-reg d-none">
                    <div class="form__modal__user__box">
                        <label class="form__modal__user__label label" for="reg-email">Ведите ваш e-mail *</label>
                        <input class="form__modal__user__input input" type="email" id="reg-email" required>
                    </div>
                    <!-- /.form__modal__user__box -->
                    <div class="form__modal__user__box">
                        <label class="form__modal__user__label label" for="reg-pass">Ведите ваш пароль *</label>
        ...
        <div class="modal__burger__body">
            <div class="header__block block">
                <nav class="burger__nav nav">
                    <a href="/" class="header__auth__link link"><img src="img/home/logo.png" alt="logo" class="header__logo logo"></a>
                    <a href="index.php" class="burger__nav__link nav__link link">Главная</a>
                    <!-- /.header__nav__link nav__link link -->
                    <a href="menu.php" class="burger__nav__link nav__link link">Меню</a>
                    <!-- /.header__nav__link nav__link link -->
                    <a href="information.php" class="burger__nav__link nav__link link">Информация</a>
                    <!-- /.header__nav__link nav__link link -->
                    <a href="blog.php" class="burger__nav__link nav__link link">Блог</a>
                    <!-- /.header__nav__link nav__link link -->
                    <a href="about.php" class="burger__nav__link nav__link link">О&nbsp;нас</a>
                    <!-- /.header__nav__link nav__link link -->
                    <a href="contacts.php" class="burger__nav__link nav__link link">Контакты</a>
                    <!-- /.header__nav__link nav__link link -->
