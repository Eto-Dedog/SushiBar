...
<head>
    ...
    <title>SushiBar - Информация</title>
</head>
<body>
        ...
        <div class="container">
            <div class="header__block block">
                ...
                <nav class="header__nav nav">
                    ...
                    <!-- /.header__nav__link nav__link link -->
                    <a href="information.php" class="header__nav__link nav__link link active">Информация</a>
                    <!-- /.header__nav__link nav__link link -->
    ...
    <div class="modal__user d-none">
        ...
        <div class="modal__user__body">
            ...
            <div class="modal__user__no-auth">
                ...
                <!-- /.modal__user__btns -->
                <form action="#" method="get" class="form-user orm__modal__user-login">
        ...
        <div class="modal__burger__body">
            <div class="header__block block">
                <nav class="burger__nav nav">
                    ...
                    <!-- /.header__nav__link nav__link link -->
                    <a href="information.php" class="burger__nav__link nav__link link active">Информация</a>
                    <!-- /.header__nav__link nav__link link -->
